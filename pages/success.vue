  ...
  methods: {
    getRandomGif() {
      const gifs = [
        ...
        'https://media.giphy.com/media/Hm3rh1nMYe9BR20ThG/giphy.gif',
        'https://media.giphy.com/media/XQf2LxzdXBt8yo6NcA/giphy.gif',
        'https://media.giphy.com/media/w0MYyUAvYCS64/giphy.gif',
        'https://media.giphy.com/media/sgZdwNkOH43wZOEUJ2/giphy.gif',
        'https://media.giphy.com/media/3ohhwemK8gvyPkHVzq/giphy.gif',
        'https://media.giphy.com/media/xTiTnLWl6ftNuZAe8E/giphy.gif',
        'https://media.giphy.com/media/i1hiQy3uVZ0KQ/giphy.gif',
        'https://media.giphy.com/media/NOSHrLbvT589ttrt8I/giphy.gif',
        'https://media.giphy.com/media/yqtpq8rqqXBh6/giphy.gif',
        'https://media.giphy.com/media/7ZvPlxBHwfK1y/giphy.gif',
        'https://media.giphy.com/media/ghutdpgRkhkxq/giphy.gif',
        'https://media.giphy.com/media/fE32ZJgwTysQo/giphy.gif',
      ]
