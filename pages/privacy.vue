      ...
      <div class="flex items-center justify-center space-x-2 pt-4">
        <div>
          ...
          <p>
            ...
            regards to the information that they shared and/or collect in Badgerd Shop. This policy is not applicable to
          ...
          <h2>Log Files</h2>
          <p>
            Badgerd Shop follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>
            Like any other website, Badgerd Shop uses 'cookies'. These cookies are used to store information including
          ...
          <p>
            You may consult this list to find the Privacy Policy for each of the advertising partners of Badgerd Shop.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on Badgerd Shop, which are sent directly to
          ...
          <p>
            Note that Badgerd Shop has no access to or control over these cookies that are used by third-party
            advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>
            Badgerd Shop's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
          ...
          <p>
            Badgerd Shop does not knowingly collect any Personal Identifiable Information from children under the age of
