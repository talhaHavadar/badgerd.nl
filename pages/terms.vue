  ...
  <div class="items-top relative flex min-h-[calc(100vh-3rem)] justify-center bg-gray-100 sm:items-center sm:pt-0">
    <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
      <div class="flex items-center justify-center space-x-2 pt-4">
        <div>
          <h2 class="my-5 text-center text-lg font-bold">Terms of Service</h2>
          <strong>OVERVIEW</strong> <br />
          This website is operated by Badgerd Technologies B.V.. Throughout the site, the terms “we”, “Badgerd Shop”,
          “us” and “our” refer to Badgerd Technologies B.V.. Badgerd Shop offers this website, including all
          ...
          Service are considered an offer, acceptance is expressly limited to these Terms of Service. <br />
          <br />
          ...
          obtained by you will meet your expectations, or that any errors in the Service will be corrected. <br />
          <br />
          ...
          take no responsibility and assume no liability for any comments posted by you or any third-party. <br />
          <br />
          ...
          Service or on any related website has been modified or updated. <br />
          <br />
          ...
          In no case shall Badgerd Shop, our directors, officers, employees, affiliates, agents, contractors, interns,
          ...
          You agree to indemnify, defend and hold harmless Badgerd Shop and our parent, subsidiaries, affiliates,
          ...
          affect the validity and enforceability of any other remaining provisions. <br />
          <br />
          ...
          to our Services (or any part thereof). <br />
          <br />
          ...
          construed in accordance with the laws of Denmark. <br />
          <br />
